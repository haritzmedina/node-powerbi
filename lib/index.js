  ...
  deleteDataset(id, callback){
    request({
      ...
      if(response.statusCode===200){
        ...
        callback('Error deleting dataset: '+id);
      }
    });
  }
  ...
  listTables(datasetId, callback){
    request({
      ...
      if(response.statusCode===200){
        ...
        callback('Error retrieving tables of dataset: '+datasetId);
      }
    });
  }
  ...
  init(){
    ...
    this.app.get('/', (req, res)=>{
      ...
      request({
        ...
        // Return data
        this.users[userUuid].callback(this.users[userUuid]);
